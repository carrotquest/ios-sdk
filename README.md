...
![Version](https://img.shields.io/static/v1?label=Version&message=3.2.1&color=brightgreen)[![SwiftPM compatible](https://img.shields.io/badge/SwiftPM-compatible-brightgreen.svg)](https://swift.org/package-manager/)
